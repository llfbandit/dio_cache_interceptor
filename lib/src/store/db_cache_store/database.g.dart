...
class $_DioCacheTable extends _DioCache
  ...
  GeneratedTextColumn _cacheControl;
  @override
  GeneratedTextColumn get cacheControl =>
      _cacheControl ??= _constructCacheControl();
  ...
  GeneratedBlobColumn _content;
  @override
  GeneratedBlobColumn get content => _content ??= _constructContent();
  ...
  GeneratedBlobColumn _headers;
  @override
  GeneratedBlobColumn get headers => _headers ??= _constructHeaders();
  ...
  GeneratedDateTimeColumn _maxStale;
  @override
  GeneratedDateTimeColumn get maxStale => _maxStale ??= _constructMaxStale();
  ...
  GeneratedDateTimeColumn _responseDate;
  @override
  GeneratedDateTimeColumn get responseDate =>
      _responseDate ??= _constructResponseDate();
...
abstract class _$DioCacheDatabase extends GeneratedDatabase {
  ...
  $_DioCacheTable _dioCache;
  $_DioCacheTable get dioCache => _dioCache ??= $_DioCacheTable(this);
  DioCacheDao _dioCacheDao;
  DioCacheDao get dioCacheDao =>
      _dioCacheDao ??= DioCacheDao(this as DioCacheDatabase);
  @override
